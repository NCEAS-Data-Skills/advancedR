...
Can't use numbers unless they're in back-ticks because R doesn't allow numbers as the first character in a variable or column name.
...
3.  On which line does `a` get copied in the following example?
    ...
    a <- c(1, 5, 3, 2)
    b <- a 
    b[[1]] <- 10 # a copied when b is modified
    ```
